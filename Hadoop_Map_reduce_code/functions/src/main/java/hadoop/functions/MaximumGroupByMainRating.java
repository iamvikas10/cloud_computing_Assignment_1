...
public class MaximumGroupByMainRating extends Configured implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf,"MaximumGroupByMainRating");
        job.setJobName("MaximumGroupByMainRating");
        job.setJarByClass(MaximumGroupByMainRating.class);

        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);

        job.setMapperClass(MaxMapRating.class);
        job.setCombinerClass(MaxReduceRating.class);
        job.setReducerClass(MaxReduceRating.class);
    ...
    public static void main(String[] args) throws Exception{
        int exitCode = ToolRunner.run(new MaximumGroupByMainRating(), args);
