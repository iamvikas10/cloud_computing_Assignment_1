...
public class SumGroupByMainUsers extends Configured implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf,"SumGroupByMainUsers");
        job.setJobName("SumGroupByMainUsers");
        job.setJarByClass(SumGroupByMainUsers.class);

        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);

        job.setMapperClass(SumMapUsers.class);
        job.setCombinerClass(SumReduceUsers.class);
        job.setReducerClass(SumReduceUsers.class);
    ...
    public static void main(String[] args) throws Exception{
        int exitCode = ToolRunner.run(new SumGroupByMainUsers(), args);
