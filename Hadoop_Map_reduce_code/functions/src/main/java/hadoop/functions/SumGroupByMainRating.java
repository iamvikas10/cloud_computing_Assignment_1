...
public class SumGroupByMainRating extends Configured implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf,"SumGroupByMainRating");
        job.setJobName("SumGroupByMainRating");
        job.setJarByClass(SumGroupByMainRating.class);

        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);

        job.setMapperClass(SumMapRating.class);
        job.setCombinerClass(SumReduceRating.class);
        job.setReducerClass(SumReduceRating.class);
    ...
    public static void main(String[] args) throws Exception{
        int exitCode = ToolRunner.run(new SumGroupByMainRating(), args);
